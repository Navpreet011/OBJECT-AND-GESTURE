...
def object_detection(engine):
    model = YOLO('C:\\Users\\Navpreet\\Downloads\\object detection (2)\\object detection\\yolow\\yolov8l.pt')
    classNames=open('C:\\Users\\Navpreet\\Downloads\\object detection (2)\\object detection\\yolow\\objname\\object.name')
...
def hand_gesture_recognition(engine):
    ...
    model = load_model('C:\\Users\\Navpreet\\Downloads\\object detection (2)\\object detection\\yolowebcam\\mp_hand_gesture')

    f = open('C:\\Users\\Navpreet\\Downloads\\object detection (2)\\object detection\\yolowebcam\\gesture.names')
    label = f.read().split('\n')
    f.close()
...
def main():
    ...
    root.iconbitmap(os.path.join(os.path.dirname(__file__), 'C:\\Users\\Navpreet\\Downloads\\object detection (2)\\object detection\\icon\\Screenshot 2024-04-13 164228.png'))
